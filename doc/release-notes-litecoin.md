...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 flies per kB (0.00001 TST). This is to prepare for dropping the minimum transaction fee to 0.1 flies per kB (0.0001 TST) in the next release.
